...
from models import ad_predict,compute_auc,compute_bestf1
...
def Trainer(model, model_optimizer, train_dl, val_dl, test_dl, device, logger, config, idx):
    ...
    for epoch in range(1, config.num_epoch + 1):
        ...
        auc = compute_auc(test_score_origin, test_target)
        bf1 = compute_bestf1(test_score_origin, test_target, return_threshold=False)
        print(f"auc: {auc}; bf1: {bf1}")
